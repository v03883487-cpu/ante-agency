...
const avatarColors = ["#F4C95D", "#E28B2F", "#22C55E", "#D7FF3F"];
...
export function Hero() {
  ...
  return (
    <section className="relative flex min-h-[92vh] flex-col overflow-hidden bg-[#0A0B0E] text-zinc-50">
        ...
        >
          ...
          >
            ...
            <span className="text-xs text-zinc-300">
              <span className="font-semibold text-white">1400+ инфлюенсеров</span> уже в базе Ante
            </span>
          </motion.div>
