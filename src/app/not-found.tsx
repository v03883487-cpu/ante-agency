...
export default function NotFound() {
  return (
    <section className="relative flex min-h-[80vh] flex-col items-center justify-center bg-white px-6 text-center text-[#0A0A0A]">
      <div className="relative flex flex-col items-center gap-6">
        <span className="font-display text-7xl font-black tracking-tight sm:text-9xl">ANTE.</span>
        <span className="font-display text-7xl font-black text-black/10 sm:text-9xl">404</span>
