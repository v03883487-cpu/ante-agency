  ...
  return (
    <>
      ...
      <section className="bg-white px-6 pb-20 sm:px-12">
        <StaggerGroup className="mx-auto grid max-w-4xl grid-cols-2 gap-4 sm:grid-cols-4">
          {[
            ...
            <StaggerItem key={i} className="card-hover rounded-2xl border border-white/10 bg-white p-6 text-center hover:border-white/30">
      ...
      <section id="plans" className="bg-white px-6 py-20 sm:px-12">
        <FadeIn className="mx-auto max-w-5xl">
          ...
          <StaggerGroup className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            {plans.map((p) => (
              <StaggerItem key={p.title} className="card-hover group relative rounded-3xl border border-white/10 bg-white p-8 hover:border-white/30">
      ...
      <section className="bg-white px-6 py-20 sm:px-12">
        <FadeIn className="mx-auto max-w-5xl">
          ...
          <StaggerGroup className="grid grid-cols-1 gap-4 sm:grid-cols-4">
            {steps.map((s) => (
              <StaggerItem key={s.n} className="card-hover rounded-3xl border border-white/10 bg-white p-8 hover:border-white/30">
      ...
      <section className="bg-white px-6 py-20 sm:px-12">
        <FadeIn className="mx-auto max-w-3xl rounded-3xl border border-white/10 bg-white p-10 text-center">
      ...
      <section id="signup" className="bg-white px-6 pb-28 sm:px-12">
        <FadeIn className="mx-auto grid max-w-4xl grid-cols-1 gap-10 sm:grid-cols-2">
          <div>
